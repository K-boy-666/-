"""
Order REST API — mock server with realistic sample data.
...
def search_orders(q: str = Query(..., description="Search keyword"), limit: int = Query(20, ge=1, le=100)):
...
def get_order_stats(period: str = Query("today", description="today|yesterday|this_week|this_month|all")):
...
def get_orders_by_customer(customer: str = Query(...), limit: int = Query(20, ge=1, le=100)):
